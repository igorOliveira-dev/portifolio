...
const Projects = React.forwardRef((props, ref) => {
  ...
  const projectDesc = [
    ...
    "Esse é um e-commerce ficticio porém completo, ele tem sistema de delivery, administração de produtos, login, entre outros, foi feito em react com firebase",

    "Esse é um site informativo sobre os benefícios de um site para uma empresa",
  ];
  const projectLinks = [
    ...
    "https://delivery-app-livid.vercel.app/",
    "https://business-site-benefits.vercel.app/",
  ];
  const codeLinks = [
    ...
    "https://github.com/igorOliveira-dev/delivery-app",
    "https://github.com/igorOliveira-dev/business-site-benefits",
  ];
  ...
  return (
    <div ref={ref}>
      <S.Container>
        ...
        <S.Carousel>
          <S.LeftArrow onClick={leftArrowClick} ref={leftReveal}>
            {"<"}
          </S.LeftArrow>
          <S.ActiveCarousel
            ref={reveal}
            onMouseOver={mouseOverCarousel}
            onMouseLeave={mouseOutCarousel}
          >
            <S.ProjectTitle>{projectTitles[activeCarousel - 1]}</S.ProjectTitle>
            <S.ProjectDesc>{projectDesc[activeCarousel - 1]}</S.ProjectDesc>
          </S.ActiveCarousel>
          <S.ProjectBtns
            onMouseOver={mouseOverCarousel}
            onMouseLeave={mouseOutCarousel}
          ...
          >
            <S.ProjectBtn
              style={{
                transform: overCarousel ? "translateY(0)" : "translateY(-800%)",
              }}
          ...
          <S.RightArrow onClick={rightArrowClick} ref={rightReveal}>
            {">"}
          </S.RightArrow>
        </S.Carousel>
      </S.Container>
